...
//        Aware.setSetting(getApplicationContext(), Aware_Preferences.STATUS_BATTERY, true);
    ...
    private void startBootESM() {
            ...
            final LinearLayout answersHolder = (LinearLayout) layout.findViewById(R.id.esm_boot_question);
            final Button answer = new Button(this);
            final Button answer2 = new Button(this);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Screen.ACTION_AWARE_SCREEN_UNLOCKED)) {
                ...
                unlocked = true;
                    ...
                    builder.setView(layout);
                    final LinearLayout answersHolder = (LinearLayout) layout.findViewById(R.id.esm_boot_question);
                    final Button answer = new Button(context);
                    final Button answer2 = new Button(context);
                    alert = builder.create();
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, 1.0f);
                    answer.setLayoutParams(params);
                    answer.setText("Start on a new objective.");
                    answer.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            mycontext.sendBroadcast(new Intent("session_boot_new"));
                            alert.dismiss();
                    ...
                    answer2.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            mycontext.sendBroadcast(new Intent("session_boot_old"));
                            alert.dismiss();
